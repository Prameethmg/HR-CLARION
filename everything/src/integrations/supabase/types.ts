...
export type Database = {
  _analytics: {
    Tables: {
      ...
      log_events_054c8cd6_4ec6_46c4_a855_be78189e20e7: {
        Row: {
          body: Json | null
      ...
      log_events_12a8850e_350b_4e9b_bc15_6202a048754f: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_22cfa40a_3df5_4045_be8a_593385774d78: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_61b6fc64_d42d_4492_8010_57776bb442ed: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_6602ac9d_09f1_4e1d_ad12_bca11bb4fcd4: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_751a9bd3_5bb6_40bf_83ad_04ea07c90dfe: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_86ab8745_a9f3_49b3_addb_6cd14a6a2acb: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_98daf782_260c_400c_9e2d_4310be84ef68: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_e1dc677b_5cbf_4ee7_b0e0_287b5af54e4b: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
  ...
  public: {
    Tables: {
      ...
      employees: {
        Row: {
          ...
          wfh_used_this_month: number | null
        }
        Insert: {
          department?: string | null
          id: string
      ...
      speakup_access_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "speakup_access_log_report_id_fkey"
            columns: ["report_id"]
            referencedRelation: "speakup_reports"
            referencedColumns: ["id"]
          },
        ]
      }
      speakup_contact: {
        ...
        Relationships: [
          {
            foreignKeyName: "speakup_contact_report_id_fkey"
            columns: ["report_id"]
            referencedRelation: "speakup_reports"
            referencedColumns: ["id"]
          },
      ...
      speakup_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "speakup_notes_report_id_fkey"
            columns: ["report_id"]
            referencedRelation: "speakup_reports"
            referencedColumns: ["id"]
          },
    ...
    Functions: {
      match_policies: {
        Args: { dept: string; match_count: number; query_embedding: string }
        Returns: {
          clause_id: string
          clause_text: string
          doc_title: string
